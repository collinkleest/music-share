...
app.get("/api/v1/users/email", async (req, res) => {
  ...
  console.log("sending email from backend");

  const transport = nodemailer.createTransport({
    host: "smtp.mailtrap.io",
    port: 2525,
    auth: {
      user: '2b605c3ed21840', //generated by Mailtrap
      pass: '9574c0cd01a2c0' //generated by Mailtrap
    }
  });
  ...
  res.send("backend at end of func");
  console.info("backend at end of func");
